...
module.exports = ({env}) => {
  return {
    ...
    //     smtpHost: 'localhost' // Default: -1 - extra smtp host after resolveM
    //   },
    //   settings: {
    //       logger: {
    //         debug: console.log,
    ...
    email: {
      config: {
        provider: 'nodemailer',
        providerOptions: {
          host: env('SMTP_HOST', 'smtp.mail.yahoo.com'),
        ...
        settings: {
          defaultFrom: 'mohammad.jadid96@yahoo.com',
          defaultReplyTo: 'mohammad.jadid96@yahoo.com',
        },
      },
    },
  }
